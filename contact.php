<?php 
	...
	#Your e-mail address
	define("__TO__","andres.arenas@arenait.co");

	#Message subject
	define("__SUBJECT____","Contacto ARENA IT ");

	#Success message
	define('__SUCCESS_MESSAGE__', "Su mensaje ha sido enviado con exito. Gracias!");

	#Error message 
	define('__ERROR_MESSAGE__', "Error, su mensaje no ha podido ser enviado");

	#Messege when one or more fields are empty
	define('__MESSAGE_EMPTY_FILDS__', "Por favor diligencie todos los campos");
